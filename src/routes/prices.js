...
const TICKERS = {
  oil:'CL=F', lng:'NG=F', iron:'TIO=F', rare:null,
  copper:'HG=F', nickel:'NI=F', aluminum:'ALI=F',
  wheat:'ZW=F', coffee:'KC=F', soy:'ZS=F', cotton:'CT=F', rubber:null,
  semi:'^SOX', car:null, battery:'LIT', steel:'SLX', fertilizer:null,
};
...
router.get('/:id', async (req, res) => {
  ...
  try {
    ...
    if (!result0) return res.json({ available: false, message: '데이터 없음' });
